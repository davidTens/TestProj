...
final class MockItemsViewService: XCTestCase, ItemsServiceProviding {
    ...
    func getData(itemsPerPage: Int, completion: @escaping TestProj.APIResult) {
        let itemModel = ArtObjects(id: UUID().uuidString, title: "title", longTitle: "longTitle", principalOrFirstMaker: "maker", productionPlaces: ["Amsterdam", "Vienna"], headerImage: .init(url: ""))
